const translations = {
    ...
    navGame: 'Peli', navFeatures: 'Ominaisuudet', navRoadmap: 'Tulossa', navHow: 'Näin pelaat', download: 'Lataa peli', release: 'Lataa uusin julkaisu', explore: 'Tutustu peliin',
    ...
    features: [
      ...
      ['Raivo on polttoaineesi', 'Ylinopeus täyttää raivomittarin. Purkaa se huudolla: torvi pärähtää, kuljettaja kiroaa ja raivonaama mittarissa vääntyy irvistykseen.'],
      ['Pidä silmät tiessä', 'Piilossa olevat peltikamerat valvovat 50 metrin lähestymisalueita. Puut huojuvat, lehdet lentävät, ja kova kolari jättää taksin savuamaan ja jumiin viideksi sekunniksi.'],
      ...
      ['Sade märkenee tien', 'Sää muuttuu lennossa: sade kastelee tien vähitellen, lätäköt roiskuvat renkaiden alla ja märkä asfaltti vie pitoa juuri silloin kun sitä eniten tarvitset.'],
      ['Jalankulkijoilla on syke', 'Asukkaat kävelevät oikeille ovilleen, odottavat suojateillä ja horjuvat baarista kotiin promillein 0.5-3.0. Yöllä he hohtavat himmeästi, ennen kuin ajovalo tai katulamppu löytää heidät.'],
      ['Liikennevalot pelaavat mukana', 'Risteykset ja liikennevalot ohjaavat sekä sinua että jalankulkijoita. Punaisten päin ajaminen näkyy suoraan taksin pistemäärässä.'],
    ],
    roadmapKicker: '03 / SEURAAVAKSI', roadmapTitle: 'Tie jatkuu.<br><em>Kaaos kasvaa.</em>', roadmapIntro: 'Tämä rakennetaan jo nyt saman asukas- ja jalankulkijamoottorin päälle, joka pyörittää peliä tänään.', roadmapSoon: 'TULOSSA',
    roadmapCards: [
      ['Täysi liikenne', 'Autonomiset autot, kilpailevat taksit ja parkkiliikenne palaavat kaduille - rakennettuna sen uuden asukas- ja jalankulkijamoottorin päälle, joka pyörii jo nyt.'],
      ['Idiootit pyörällä', 'Pyöräilijät liittyvät joukkoon: väistelevät, ajavat puna-päin ja tekevät juuri sitä, mitä pyöräilijät parhaiten osaavat.'],
  ...
  en: {
    navGame: 'Game', navFeatures: 'Features', navRoadmap: "What's next", navHow: 'How to play', download: 'Download', release: 'Download latest release', explore: 'Explore the game',
    ...
    features: [
      ...
      ['Pedestrians with a pulse', 'Residents walk to their own doors, wait at crossings, and stumble home from the bar at 0.5-3.0 promille. At night they glow faintly until a headlight or streetlight finds them.'],
    ...
    roadmapCards: [
      ['Full NPC traffic', 'Autonomous cars, rival taxis, and parked traffic return to the streets - built on the same new resident and pedestrian engine already running today.'],
...
function setLanguage(next) {
  ...
  navLinks[4].innerHTML = `${t.download} <span aria-hidden="true">↗</span>`;
