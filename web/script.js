const translations = {
  fi: { navGame: 'Peli', navFeatures: 'Ominaisuudet', navHow: 'Näin pelaat', download: 'Lataa peli', release: 'Lataa viimeisin julkaisu', explore: 'Tutustu peliin', kicker: 'Ylhäältä kuvattu taksipeli · Suomi', title: 'Toimita kyydit.<br><em>Haasta tie.</em>', copy: 'Oikeita suomalaisia katuja. Kohtuutonta liikennettä. Yksi taksinkuljettaja, jonka mitta on täynnä.', introKicker: '01 / TYÖ', intro: 'Yksi kaupunki.<br><span>Loputtomasti selityksiä.</span>', lead: 'The Road Rage Trip on ylhäältä kuvattu taksipeli, joka käyttää Suomen oikeita OpenStreetMap-teitä.', introText: 'Nouda vieraita, pujottele elävillä kaduilla, väistä kaaosta ja vie heidät perille ennen kuin kärsivällisyytesi loppuu. Jokainen reitti on hieman erilainen. Jokainen virhe maksaa.', featureKicker: '02 / KONEPELLIN ALLA', featureTitle: 'Tehty<br><em>kauniisti ärtyneille.</em>', featureIntro: 'Tämä ei ole tausta. Elävä tieverkosto pistää vastaan.', features: [['Oikeita teitä, oikeita paikkoja', 'Aja suomalaisilla kaduilla, jotka syntyvät OSM-geometriasta rakennuksineen, puistoineen, vesistöineen ja kohteineen.'], ['Taksityötä terällä', 'Etsi kyytejä puhelimesta, nouda matkustajia, kerää bonuksia ja pidä mittari liikkeessä arvaamattomassa liikenteessä.'], ['Silmät tiessä', 'Piilossa olevat nopeuskamerat valvovat ajosuuntia. Puut huojuvat, lehdet lentävät ja kova kolari saa taksin savuamaan.']], howKicker: '03 / RATTIIN', howTitle: 'Tunne<br><span>säännöt.</span><br>Riko rauha.', howLead: 'Kaupunki on sinun navigoitavaksesi. Pisteet ovat sinun pilattavaksesi.', controls: ['Aja, jarruta, ohjaa', 'Avaa taksin puhelin', 'Raivohuuto: raivaa tie', 'Avaa ohjeet ja tavoite', 'Tauko, asetukset, kaupungin vaihto'], releaseKicker: 'VIIMEISIN JULKAISU', releaseTitle: 'Seuraava kyytisi<br>odottaa.', releaseText: 'Lataa uusin Windows-versio GitHub Releases -sivulta ja lähde tien päälle.', releaseButton: 'Avaa GitHub Releases', scroll: 'VIERITÄ ALASPÄIN', toggle: 'Vaihda kieleksi English' },
